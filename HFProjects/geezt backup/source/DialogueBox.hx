...
class DialogueBox extends FlxSpriteGroup
{
	...
	public function new(talkingRight:Bool = true, ?dialogueList:Array<String>)
	{
		...
		switch (PlayState.SONG.song.toLowerCase())
		{
			...
			case 'echo enzyme' | 'biohazard' | 'jeez':
				hasDialog = true;
				...
				// Above me causes so much havoc and self hate I hate you indices :)
				box.width = 200;
				box.height = 200;
				box.x = -120;
				box.y = 140;
		...
		if (PlayState.SONG.song.toLowerCase() == 'echo enzyme' || PlayState.SONG.song.toLowerCase() == 'biohazard') {
		...
		if (PlayState.SONG.song.toLowerCase() == 'echo enzyme' || PlayState.SONG.song.toLowerCase() == 'biohazard' || PlayState.SONG.song.toLowerCase() == 'jeez' ) {
